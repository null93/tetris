...
import com.tetris.graphic.Button;
...
class ControlPanel extends JPanel {
	...
	public ControlPanel () {
		...
		this.moveLeft = createButton ( "images/left.png", 75, 40, 0, 133 );
		this.moveLeft.setFocusable(false);
		this.moveRight = createButton ( "images/right.png", 75, 40, 100, 133 );
		this.moveRight.setFocusable(false);
		this.rotateLeft = createButton ( "images/counter_clockwise.png", 75, 40, 0, 198 );
		this.rotateLeft.setFocusable(false);
		this.rotateRight = createButton ( "images/clockwise.png", 75, 40, 100, 198 );
